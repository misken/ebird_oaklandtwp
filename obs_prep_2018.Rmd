...
```{r}
obs_raw <- read.csv("./data/observations_2018.csv")
```
...
```{r}
ot_birders <- c("VanderWeide", "Isken", "Kriebel", "Radzwion",
                "Kent", "Western")
```
